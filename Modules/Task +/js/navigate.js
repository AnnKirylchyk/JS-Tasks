...
export async function navigate(cardName) {   // делаем функцию асинхронной
  ...
  switch (cardName) {
      case "add":
          ...
          break
      case "edit":
          const editCard = await import("./editCard.js")  // import асинхронная функция, все экспортируемые сущности из этого модуля помещ в этот объект
          editCard.default(appEl)
          loaderEl.remove()
          break
      default:
